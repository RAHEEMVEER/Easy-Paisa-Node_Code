...
async function easyApp() {
  ...
  if (passwordInput.pass === pin) {
    ...
    console.log(
      chalk.yellow.italic.bold(`\t\t      WELLCOME TO EASY PAISA APP:`)
    );
    console.log(
      chalk.green.italic.bold(`\t\t========================================\n`)
    );
      ...
      if (input.choice === "CHECK-BALANCE:") {
        ...
        console.log(
          chalk.blue.italic.bold(
            `\t\t    YOUR CURRENT BALANCE IN EASYPAISA IS: `
          ) + chalk.yellow.italic(`${easyPaisaBalance}`)
        );
        console.log(
          chalk.green.italic.bold(
            `\t\t=====================================================\n`
        ...
        let input2 = await inquirer.prompt([
          {
            ...
            type: "number",
            message:
              "HOW MUCH MONEY YOU WANT TO ADD IN YOUR EASY PAISA ACCOUNT ?",
          },
        ]);
        console.log(
          chalk.green.italic.bold(
        ...
        console.log(
          chalk.yellow.italic.bold(
            `\t\t   NOW YOUR BALANCE IN EASYPAISA IS: `
          ) + chalk.blue.italic(`${easyPaisaBalance + input2.amount}`)
        );
        console.log(
          chalk.green.italic.bold(
            `\t\t===============================================\n`
        ...
        while (input3.receiver.length < 4) {
          ...
          console.log(
            chalk.red.italic.bold(
              `\t\t   PLEASE ENTER RECEIVER ACCOUNT NAME ABOVE: 4`
            )
          );
          console.log(
            chalk.blue.italic.bold(
        ...
        while (input4.receiver_account_number.length < 11) {
          ...
          console.log(
            chalk.red.italic.bold(
              `\t\t  ACCORDING TO NATIONALITY +92. THE NUMBER SHOULD BE IN 11 DIGITS.`
            )
          );
          console.log(
            chalk.yellow.italic.bold(
        ...
        if (input5.receiver_amount > easyPaisaBalance) {
          ...
          console.log(
            chalk.yellow.italic.bold(`\t\t     YOU HAVE `) +
              chalk.red.italic.bold(
                `${input5.receiver_amount - easyPaisaBalance}`
              ) +
          ...
          console.log(
            `YOU TRANSFERRED ${input5.receiver_amount} TO ${input3.receiver} ACCOUNT NUMBER IS: ${input4.receiver_account_number}`
          );
        ...
        if (input6.donation === "JDC FOUNDATION:") {
          ...
          if (input6_1.jdc === "FOR ORPHAN CHILDS:") {
            ...
            if (orphanChild.orphan_child > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t  YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${orphanChild.orphan_child - easyPaisaBalance}`
                  ) +
            ...
            if (hungryPeoples.hungry_peoples > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t  YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${hungryPeoples.hungry_peoples - easyPaisaBalance}`
                  ) +
                  chalk.blue.italic.bold(
                    ` RS LESS FOR HUNGRY PEOPLES DONATION.`
                  )
              );
              console.log(
                chalk.green.italic.bold(
            ...
            let builtHospital = await inquirer.prompt({
              ...
              type: "number",
              message:
                "HOW MUCH MONEY YOU WANT TO DONATE TO BUILT FREE HOSPITALS ?",
            });
            if (builtHospital.hospitals > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t  YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${builtHospital.hospitals - easyPaisaBalance}`
                  ) +
                  chalk.blue.italic.bold(
                    ` RS LESS TO BUILT FREE HOSPITAL DONATION.`
                  )
              );
              console.log(
                chalk.green.italic.bold(
            ...
            let builtSchool = await inquirer.prompt({
              ...
              type: "number",
              message:
                "HOW MUCH MONEY YOU WANT TO DONATE TO BUILT FREE SCHOOLS ?",
            });
            if (builtSchool.schools > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t  YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${builtSchool.schools - easyPaisaBalance}`
                  ) +
                  chalk.blue.italic.bold(
                    ` RS LESS TO BUILT FREE SCHOOLS DONATION.`
                  )
              );
              console.log(
                chalk.green.italic.bold(
          ...
          let alKhidmat = await inquirer.prompt([
            {
              ...
              message:
                "SELECT FOR AL-KHIDMAT DONATION TYPES YOU WANT TO DONATE.",
            },
          ]);
          //===================================================(THIRTENTH STEP)=========================================================
          if (alKhidmat.service === "IT SERVICES:") {
            ...
            let gazaFund = await inquirer.prompt([
              {
                ...
                type: "number",
                message:
                  "HOW MUCH MONEY YOU WANT TO DONATE FOR PALESTINE GAZA PEOPLES.",
              },
            ]);
            ...
            if (poorPeople.poorPeop > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t      YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${poorPeople.poorPeop - easyPaisaBalance}`
                  ) +
          ...
          if (edhi.service === "FUNDS FOR PATIENTS:") {
            ...
            if (ambulance.fund > easyPaisaBalance) {
              ...
              console.log(
                chalk.blue.italic.bold(`\t\t         YOU HAVE `) +
                  chalk.red.italic.bold(
                    `${ambulance.fund - easyPaisaBalance}`
                  ) +
            ...
            if (oldAge.fund > easyPaisaBalance) {
              ...
              console.log(
                chalk.green.italic.bold(`\t\t                 YOU DONATE `) +
        ...
        if (billsChoice.bills === "ELECTRICITY BILL:") {
          ...
          if (electricity.bill > easyPaisaBalance) {
            ...
            console.log(
              chalk.blue.italic.bold(`\t\t   YOU HAVE `) +
                chalk.red.italic.bold(
                  `${electricity.bill - easyPaisaBalance}`
                ) +
            ...
            console.log(
              chalk.green.bold.italic(`\t\t     PAYMENT SUCCESFULLY PAID:`)
            );
            console.log(
              chalk.yellow.italic.bold(
                `\t\t=======================================\n`
        ...
        console.log(
          chalk.green.italic.bold(`\t\t          CREATOR BY "RAHEEM VEER:"`) +
            chalk.yellow.italic.bold(
    ...
    console.log(
      chalk.red.italic.bold(
        `\t\t  EASYPAISA PASSWORD IS INCORRECT: PLEASE TRY AGAIN!!!`
      )
    );
    console.log(
      chalk.green.italic.bold(
